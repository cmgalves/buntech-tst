...
@Component({
  selector: 'app-produtoAndamento',
  templateUrl: './produtoAndamento.component.html',
  styleUrls: ['./produtoAndamento.component.css']
})

export class ProdutoAndamentoComponent implements OnInit {
  ...
  detalhe(row) {
    ...
    this.router.navigate(['produtoAndamentoDetalhe']);
  }
