			...
			begin
				...
				if @loteOP > '000000000'
					begin
						...
						update PCP..oppcfLote set lote = @loteOP, analise = @analiseProx, loteAprov = 'ABERTO', regTipo = 'N' where filial = @filial and op = @op and produto = @produto and dtime >= @horade and dtime < @horate
				...
				if @loteOP = '000000000'
					begin 
						...
						update PCP..oppcfLote set lote = @lote, analise = 'A01', loteAprov = 'ABERTO', regTipo = 'N' where filial = @filial and op = @op and produto = @produto and dtime >= @horade and dtime < @horate
